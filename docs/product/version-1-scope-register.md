...
| Task 88G CI-diagnose lock | Locked | N/A | N/A | N/A | CI execution/logging blocked buiten app-code (vermoed platform/account/repository-level) | 6 normale CI jobs + minimale diagnostic workflow falen; geen bruikbare logs/artifacts; geen featurewerk/Task 89 tot CI hersteld is. |
