...
| 23 | Research source archive | V1 governance en betrouwbaarheid | Planned | Storage foundation implemented | API implemented (metadata-only) | Planned | Implemented | This register | In progress | Metadata-only API basis toegevoegd; geen upload/fetch/parsing/AI/IBKR/suggesties/orders. |
