- Task 127: **completed** — productdocumentatie uitgelijnd met account-mode-aware IBKR productrichting: paper-only is niet langer productidentiteit; accountmodus moet zichtbaar zijn in GUI; IBKR blijft operationele source of truth; kern blijft nauwkeurige auditeerbare actiesuggesties; geen runtimegedrag gewijzigd.
...
- Huidige toestand: **na Task 125C-C**.
