...
- Slice 22 — Task 177: V1 release readiness — deterministic readiness scorecard, env-var + secret docs, deployment notes, end-to-end acceptance test against IBKR paper + EODHD + AI provider stubs.
