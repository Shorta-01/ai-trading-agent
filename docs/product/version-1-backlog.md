...
- Slice 20 — Task 175: Full IBKR order vocabulary — extend `AssetActionDraftRecord` + submission client to MKT / STP / STP LMT / TRAIL / TRAIL LMT / bracket / conditional. Per-type dry-run safety checks; UI shows the order type per draft.
