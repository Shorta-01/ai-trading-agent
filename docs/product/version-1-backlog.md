...
- Slice 19 — Task 174: Fractional Kelly + risk-parity sizing replacing the current fixed-buy-value rule. Per-asset cap 5%, per-sector cap 30%. Driven by the ensemble's distribution.
