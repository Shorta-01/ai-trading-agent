...
- Slice 21 — Task 176: Scheduler-driven 07:00 morning chain — the 06:30 cron triggers: market-data sync → ensemble forecast → suggestions → Decision Packages → action drafts → daily briefing. Briefing surfaces the universe-scan candidates beside portfolio + watchlist.
