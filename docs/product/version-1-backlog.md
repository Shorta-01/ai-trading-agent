...
- Volgende conservatieve stap: Task 107 — beperkte documentatie-follow-up op read-only terminology lock-sustainability en trackingdiscipline, zonder start van market-data runtime.
