...
- Slice 18 — Task 173: AI predictor — foundation TS model (TimesFM / Chronos / Lag-Llama) behind a provider boundary mirroring Slice 10. Stub-or-real factory; graceful degrade if the model is unreachable.
