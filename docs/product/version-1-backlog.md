...
- Volgende conservatieve stap: Task 106 — beperkte documentatie-follow-up op read-only terminology lock-consistentie en trackingdiscipline, zonder start van market-data runtime.
