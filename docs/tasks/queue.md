...
- **T-032** — `system-morning-briefing-07-00.md` system-tick workflow doc (07:00 cron fire: ALL 5 sub-steps run; _relabel_morning_briefing mechanism; the only LLM-cost fire; **dual-scheduler doctrine drift** between worker scheduler.py and API morning_chain.py). *Branch:* `task/T-032-reality-system-morning-briefing`.
