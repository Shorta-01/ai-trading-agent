...
- **T-031** — `system-morning-pre-briefing-06-00.md` system-tick workflow doc (06:00 cron fire: market-data + calibration only; forecasting / DP composition / daily briefing all skipped until 07:00; 6 mode_detected outcomes). *Branch:* `task/T-031-reality-system-morning-pre-briefing`.
