...
- **T-040** — `05-testing-and-ci.md` architecture review doc (8 verdict-driven questions: 240-file/56k-LOC Python test suite + real-impl discipline (3 of 240 mock ~1%) + zero conftest.py + no coverage + no parallelism + only parametrize markers + 10-job CI matrix + frontend test split). *Branch:* `task/T-040-architecture-testing-and-ci`.
