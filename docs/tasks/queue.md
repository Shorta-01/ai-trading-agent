...
- **T-024** — `predictor-backtest-and-leaderboard.md` workflow doc (backtest harness presence/absence + predictor registry + leaderboard UI/API + 4-stage entry path + shadow-mode infrastructure + weight floor/ceiling enforcement; ADR-0003 1-of-7-predictors gap 5th re-confirmation). *Branch:* `task/T-024-reality-predictor-backtest-and-leaderboard`.
