...
- **T-048** — `05-operational-gaps.md` Track 1c gap analysis (≥12 operational/security/observability/deployment gaps; auth topology + backup tooling Critical pre-deploy blockers; AGENTS.md backup mandate explicitly violated). *Branch:* `task/T-048-gap-operational`.
