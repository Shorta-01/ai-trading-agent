...
- **T-044** — `01-missing-features.md` Track 1c gap analysis OPENING (≥12 user-facing missing-feature gap entries; 6-part format name+why+where+effort+dependency+MoSCoW; opens Track 1c). *Branch:* `task/T-044-gap-missing-features`.
