...
- **T-025** — `user-confirm-starter-watchlist.md` user-action workflow doc (BEVESTIG ritual: banner sighting → /volglijst → optimistic-archive flow → uppercase-case-sensitive BEVESTIG token → 4-gate validation → state transition + audit). *Branch:* `task/T-025-reality-user-confirm-starter-watchlist`.
