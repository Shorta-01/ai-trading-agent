...
- **T-047** — `04-ai-integration-gaps.md` Track 1c gap analysis (≥12 AI provider/voice/budget/explanation gaps; Case-B AnthropicTsModelProvider production-path drift dominant gap). *Branch:* `task/T-047-gap-ai-integration`.
