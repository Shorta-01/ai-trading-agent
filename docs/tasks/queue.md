...
- **T-038** — `03-frontend-stack.md` architecture review doc (8 verdict-driven questions: Next.js 15.2.6 + App Router + React 19 + TypeScript 5.7 strict + 60% "use client" + no state management lib + manual apiClient.ts + inline styles + polling-heavy refresh). *Branch:* `task/T-038-architecture-frontend-stack`.
