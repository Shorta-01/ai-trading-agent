...
- **T-016b** — `prediction-track-record-screen.md` functional-review carry-forward reality doc (screen ABSENT — backend /prediction-diary data exists, no frontend screen; would host the leaderboard per intent; parallels T-024 §10.7 + T-044 §4). *Branch:* `task/T-016b-reality-prediction-track-record-screen`.
