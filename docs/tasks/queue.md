...
- **T-011c** — `dashboard-composition.md` functional-review carry-forward reality doc (dashboard contract as a whole vs intent §1 3-area+system-health-line+PAPER/REAL contract; violations: charts forbidden-but-present, no actions/watchlist area, no single system-health line). *Branch:* `task/T-011c-reality-dashboard-composition`.
