...
- **T-029** — `user-edit-trading-settings.md` user-action workflow doc (Instellingen page with single editable field user_buffer_eur out of 11 user-strategy fields; read-modify-write with hard-coded reason_nl; 10-of-11 invisible fields dominant finding). *Branch:* `task/T-029-reality-user-edit-trading-settings`.
