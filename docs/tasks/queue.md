...
- **T-046** — `03-quant-and-forecasting-gaps.md` Track 1c gap analysis (≥12 predictor/quant/forecasting/backtest gaps; ADR-0003 1-of-7 dominant gap; weight floor 5%-vs-10% numeric contradiction). *Branch:* `task/T-046-gap-quant-and-forecasting`.
