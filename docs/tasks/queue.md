...
- **T-036** — `01-monorepo-structure.md` architecture review doc (first of 8 Track 1b docs; verdict-driven format: current + alternative + verdict + perf + improvement for 8 structural choices). *Branch:* `task/T-036-architecture-monorepo-structure`.
