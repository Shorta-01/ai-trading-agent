...
- **T-037** — `02-python-stack.md` architecture review doc (8 verdict-driven questions: Python 3.12 + FastAPI sync routes + AsyncIO usage + Pydantic v2 + SQLAlchemy Core + psycopg v3 + ibapi pin + APScheduler). *Branch:* `task/T-037-architecture-python-stack`.
