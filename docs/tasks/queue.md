...
- **T-011b** — `hourly-decision-refresh.md` functional-review carry-forward reality doc (intent vs reality of "lighter hourly run" — T-033 already documented the empty-fire gap; T-011b closes the carry-forward ledger). *Branch:* `task/T-011b-reality-hourly-decision-refresh`.
