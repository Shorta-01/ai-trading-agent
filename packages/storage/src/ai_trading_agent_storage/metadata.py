...
request_logs = Table(
    ...
    Column("request_kind", Text, nullable=False), Column("request_target", Text, nullable=False), Column("request_parameters_hash", Text, nullable=True), Column("request_parameters_redacted_json", JSON, nullable=True),
    Column("requested_time_range_start", DateTime(timezone=True), nullable=True), Column("requested_time_range_end", DateTime(timezone=True), nullable=True), Column("requested_granularity", Text, nullable=True), Column("requested_snapshot_type", Text, nullable=True), Column("pacing_bucket", Text, nullable=True), Column("pacing_weight", Integer, nullable=True), Column("pacing_reset_at", DateTime(timezone=True), nullable=True), Column("provider_request_budget_remaining", Integer, nullable=True), Column("local_throttle_status", Text, nullable=True), Column("retry_count", Integer, nullable=True), Column("next_retry_not_before", DateTime(timezone=True), nullable=True),
    Column("request_status", Text, nullable=False), Column("provider_status_code", Text, nullable=True), Column("provider_error_code", Text, nullable=True), Column("provider_error_message_redacted", Text, nullable=True), Column("outcome_reason_code", Text, nullable=True), Column("received_record_count", Integer, nullable=True), Column("stored_record_count", Integer, nullable=True), Column("rejected_record_count", Integer, nullable=True), Column("null_or_empty_response", Boolean, nullable=True),
    Column("initiated_by", Text, nullable=False), Column("initiated_by_job_id", Text, nullable=True), Column("triggered_by_event_id", Text, nullable=True), Column("linked_readiness_evaluation_id", Text, nullable=True), Column("linked_freshness_audit_id", Text, nullable=True), Column("audit_notes_nl", Text, nullable=True),
    Column("safe_for_analysis", Boolean, nullable=False, server_default=sa_false()), Column("safe_for_suggestions", Boolean, nullable=False, server_default=sa_false()), Column("safe_for_action_drafts", Boolean, nullable=False, server_default=sa_false()), Column("explanation_nl", Text, nullable=False),
)
provider_sources = Table("provider_sources", metadata, Column("provider_source_id", Text, primary_key=True), Column("provider_code", Text, nullable=False), Column("provider_display_name", Text, nullable=True), Column("provider_kind", Text, nullable=False), Column("data_domain", Text, nullable=False), Column("source_type", Text, nullable=False), Column("source_authority_level", Text, nullable=True), Column("source_credibility_scope", Text, nullable=True), Column("source_license_scope", Text, nullable=True), Column("source_terms_scope", Text, nullable=True), Column("provider_environment", Text, nullable=False), Column("provider_account_mode", Text, nullable=False), Column("official_source", Boolean, nullable=True), Column("broker_source", Boolean, nullable=True), Column("user_uploaded_source", Boolean, nullable=True), Column("third_party_market_data_source", Boolean, nullable=True), Column("derived_source", Boolean, nullable=True), Column("source_url_hash", Text, nullable=True), Column("source_version", Text, nullable=True), Column("source_effective_from", DateTime(timezone=True), nullable=True), Column("source_effective_to", DateTime(timezone=True), nullable=True), Column("created_at", DateTime(timezone=True), nullable=False), Column("updated_at", DateTime(timezone=True), nullable=False), Column("disabled_at", DateTime(timezone=True), nullable=True), Column("disabled_reason", Text, nullable=True), Column("audit_notes_nl", Text, nullable=True), Column("explanation_nl", Text, nullable=False))
freshness_audit_records = Table("freshness_audit_records", metadata, Column("freshness_audit_id", Text, primary_key=True), Column("evaluated_at", DateTime(timezone=True), nullable=False), Column("data_domain", Text, nullable=False), Column("provider_code", Text, nullable=True), Column("source_type", Text, nullable=True), Column("asset_id", Text, nullable=True), Column("asset_listing_id", Text, nullable=True), Column("ibkr_conid", Text, nullable=True), Column("snapshot_id", Text, nullable=True), Column("snapshot_as_of", DateTime(timezone=True), nullable=True), Column("observed_at", DateTime(timezone=True), nullable=True), Column("received_at", DateTime(timezone=True), nullable=True), Column("stored_at", DateTime(timezone=True), nullable=True), Column("age_seconds", Integer, nullable=True), Column("freshness_policy_code", Text, nullable=False), Column("freshness_status", Text, nullable=False), Column("freshness_reason_code", Text, nullable=True), Column("freshness_window_seconds", Integer, nullable=True), Column("market_session_context", Text, nullable=True), Column("market_calendar_status", Text, nullable=True), Column("stale_after", DateTime(timezone=True), nullable=True), Column("expires_at", DateTime(timezone=True), nullable=True), Column("safe_for_analysis", Boolean, nullable=False, server_default=sa_false()), Column("safe_for_suggestions", Boolean, nullable=False, server_default=sa_false()), Column("safe_for_action_drafts", Boolean, nullable=False, server_default=sa_false()), Column("linked_request_log_id", Text, nullable=True), Column("linked_readiness_evaluation_id", Text, nullable=True), Column("blocker_summary_nl", Text, nullable=True), Column("audit_help_nl", Text, nullable=True), Column("explanation_nl", Text, nullable=False))
