...
class SuggestionBlockedReason(StrEnum):
    ...
    MARKET_STATUS_STALE = "market_status_stale"
    MARKET_SESSION_NOT_SUPPORTED = "market_session_not_supported"
    PRE_MARKET_WARNING = "pre_market_warning"
    POST_MARKET_WARNING = "post_market_warning"
    AUCTION_STATE_WARNING = "auction_state_warning"
