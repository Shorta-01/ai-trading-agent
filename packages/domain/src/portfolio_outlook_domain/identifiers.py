...
StorageProfileId = SafeIdentifier
StorageBackendId = SafeIdentifier
StorageReadinessCheckId = SafeIdentifier
StorageSchemaVersionId = SafeIdentifier
StorageMigrationPlanId = SafeIdentifier
StorageRetentionPolicyId = SafeIdentifier
