...
def _report() -> MigrationReadinessReport:
    return MigrationReadinessReport(
        ...
        latest_expected_revision_id="0064_runtime_config_execution_gates",
        database_revision_id="0064_runtime_config_execution_gates",
    ...
    with engine.begin() as conn:
        ...
        conn.execute(
            text(
                ...
                "('0064_runtime_config_execution_gates')"
            )
        )
