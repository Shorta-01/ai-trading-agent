...
from portfolio_outlook_api.pauze_routes import (
    router as pauze_router,
)
...
from portfolio_outlook_api.profit_target_routes import (
    router as profit_target_router,
)
